...
class _TipsState extends State<Tips> {
  List<Info> infos = [
    ...
    Info(
        ...
        subtitle:
            'Choosing the right time to plant is the most important part of planting. The best strategy to use to increase yields is your soil is reacty, start planting Early planting can result in increased crop yields.Select the right time to plant this is a critical process of planting if soil is ready, do the planting several tests can be performed to test how ready your solls.'),
    Info(
